  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        ...
        side={side}
        sideOffset={6}
        className="flex w-80 flex-col gap-3.5 rounded-2xl border bg-card p-4 text-card-foreground shadow-2xl transition-all duration-150 cursor-default select-none"
        onClick={event => event.stopPropagation()}
      >
