...
export function AccountMenu({ containerRef, isOpen, onLock, onToggle, session }: AccountMenuProps) {
        ...
        <div className={styles.accountWrap} ref={containerRef}>
            ...
            {isOpen ? (
                <section className={styles.accountMenu} aria-label="Account details">
                    ...
                    <button className={styles.lockButton} onClick={() => void onLock()} type="button">
                        <LogOut size={16} />
                        Lock Flow
                    </button>
                </section>
